...
async def delete_user_data(user_id: str , current_user=Depends(auth_handler.auth_wrapper)):
...
async def update_user_data(user_id: str, updated_user: UpdateUserModel = Body(...), current_user=Depends(auth_handler.auth_wrapper)):
